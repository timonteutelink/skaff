...
}:
{
  ...
  "@aws-sdk/client-cloudfront@3.932.0" = fetchurl {
  ...
  "@aws-sdk/client-s3@3.932.0" = fetchurl {
  ...
  "@aws-sdk/client-sso@3.932.0" = fetchurl {
  ...
  "@aws-sdk/credential-provider-ini@3.932.0" = fetchurl {
  ...
  "@aws-sdk/credential-provider-node@3.932.0" = fetchurl {
  ...
  "@aws-sdk/credential-provider-sso@3.932.0" = fetchurl {
  ...
  "@aws-sdk/credential-provider-web-identity@3.932.0" = fetchurl {
  ...
  "@aws-sdk/middleware-recursion-detection@3.930.0" = fetchurl {
  ...
  "@aws-sdk/nested-clients@3.932.0" = fetchurl {
  ...
  "@aws-sdk/token-providers@3.932.0" = fetchurl {
  ...
  "@aws/lambda-invoke-store@0.1.1" = fetchurl {
  ...
  "@babel/parser@7.26.10" = fetchurl {
    url = "https://registry.npmjs.org/@babel/parser/-/parser-7.26.10.tgz";
    hash = "sha512-6aQR2zGE/QFi8JpDLjUZEPYOs7+mhKXm86VaKFiLP35JQwQb6bwUE+XbvkH0EptsYhbNBSUGaUBLKqxH1xSgsA==";
  };
  ...
  "@babel/traverse@7.25.9" = fetchurl {
    url = "https://registry.npmjs.org/@babel/traverse/-/traverse-7.25.9.tgz";
    hash = "sha512-ZCuvfwOwlz/bawvAuvcj8rrithP2/N55Tzz342AkTvq4qaWbGfmCk/tKhNaV2cthijKrPAA8SRJV5WWe7IBMJw==";
  };
  ...
  "@babel/types@7.26.10" = fetchurl {
    url = "https://registry.npmjs.org/@babel/types/-/types-7.26.10.tgz";
    hash = "sha512-emqcG3vHrpxUKTrxcblR36dcrcoRDvKmnL/dCL6ZsHaShW80qxCAcNhzQZrpeM765VzEos+xOi4s+r4IXzTwdQ==";
  };
  ...
  "@endo/module-source@1.3.3" = fetchurl {
    url = "https://registry.npmjs.org/@endo/module-source/-/module-source-1.3.3.tgz";
    hash = "sha512-BsnzQDVxHVdE5otMextsqZvXEko1N+djde1Y/lrbZp+/gn0x9O9x30ZUG8Yt84Vob4sxjL9I7piTVE/px5cuog==";
  };
  "@es-joy/jsdoccomment@0.50.2" = fetchurl {
  ...
  "@eslint/css-tree@3.6.6" = fetchurl {
  ...
  "@inquirer/checkbox@5.0.1" = fetchurl {
  ...
  "@inquirer/confirm@3.2.0" = fetchurl {
  ...
  "@inquirer/confirm@6.0.1" = fetchurl {
  ...
  "@inquirer/editor@5.0.1" = fetchurl {
  ...
  "@inquirer/expand@5.0.1" = fetchurl {
  ...
  "@inquirer/external-editor@2.0.1" = fetchurl {
  ...
  "@inquirer/figures@2.0.1" = fetchurl {
  ...
  "@inquirer/number@4.0.1" = fetchurl {
  ...
  "@inquirer/password@5.0.1" = fetchurl {
  ...
  "@inquirer/prompts@8.0.1" = fetchurl {
  ...
  "@inquirer/rawlist@5.0.1" = fetchurl {
  ...
  "@inquirer/search@4.0.1" = fetchurl {
  ...
  "@inquirer/select@2.5.0" = fetchurl {
  ...
  "@inquirer/select@5.0.1" = fetchurl {
  ...
  "@jest/create-cache-key-function@30.2.0" = fetchurl {
  ...
  "@jest/environment@30.2.0" = fetchurl {
  ...
  "@jest/expect-utils@30.2.0" = fetchurl {
  ...
  "@jest/fake-timers@30.2.0" = fetchurl {
  ...
  "@jest/reporters@30.2.0" = fetchurl {
  ...
  "@jest/snapshot-utils@30.2.0" = fetchurl {
  ...
  "@jest/test-result@30.2.0" = fetchurl {
  ...
  "@jest/test-sequencer@30.2.0" = fetchurl {
  ...
  "@jest/transform@30.2.0" = fetchurl {
  ...
  "@next/eslint-plugin-next@16.0.3" = fetchurl {
  ...
  "@npmcli/arborist@8.0.1" = fetchurl {
  ...
  "@npmcli/map-workspaces@4.0.2" = fetchurl {
  ...
  "@npmcli/metavuln-calculator@8.0.1" = fetchurl {
  ...
  "@npmcli/name-from-folder@3.0.0" = fetchurl {
  ...
  "@oclif/plugin-help@6.2.36" = fetchurl {
  ...
  "@oclif/plugin-not-found@3.2.72" = fetchurl {
  ...
  "@oclif/plugin-plugins@5.4.54" = fetchurl {
  ...
  "@oclif/plugin-update@4.7.16" = fetchurl {
  ...
  "@oclif/plugin-warn-if-update-available@3.1.53" = fetchurl {
  ...
  "@oclif/prettier-config@0.2.1" = fetchurl {
  ...
  "@react-dnd/invariant@2.0.0" = fetchurl {
  ...
  "@react-dnd/shallowequal@2.0.0" = fetchurl {
  ...
  "@sinonjs/fake-timers@13.0.5" = fetchurl {
  ...
  "@smithy/middleware-endpoint@4.3.11" = fetchurl {
  ...
  "@smithy/middleware-retry@4.4.11" = fetchurl {
  ...
  "@smithy/smithy-client@4.9.7" = fetchurl {
  ...
  "@smithy/util-defaults-mode-browser@4.3.10" = fetchurl {
  ...
  "@smithy/util-defaults-mode-node@4.2.13" = fetchurl {
  ...
  "@stylistic/eslint-plugin@3.1.0" = fetchurl {
  ...
  "@stylistic/eslint-plugin@5.5.0" = fetchurl {
  ...
  "@swc/core-darwin-arm64@1.15.2" = fetchurl {
  ...
  "@swc/core-darwin-x64@1.15.2" = fetchurl {
  ...
  "@swc/core-linux-arm-gnueabihf@1.15.2" = fetchurl {
  ...
  "@swc/core-linux-arm64-gnu@1.15.2" = fetchurl {
  ...
  "@swc/core-linux-arm64-musl@1.15.2" = fetchurl {
  ...
  "@swc/core-linux-x64-gnu@1.15.2" = fetchurl {
  ...
  "@swc/core-linux-x64-musl@1.15.2" = fetchurl {
  ...
  "@swc/core-win32-arm64-msvc@1.15.2" = fetchurl {
  ...
  "@swc/core-win32-ia32-msvc@1.15.2" = fetchurl {
  ...
  "@swc/core-win32-x64-msvc@1.15.2" = fetchurl {
  ...
  "@types/fs-extra@11.0.4" = fetchurl {
  ...
  "are-docs-informative@0.0.2" = fetchurl {
  ...
  "babel-plugin-jest-hoist@30.2.0" = fetchurl {
  ...
  "babel-preset-jest@30.2.0" = fetchurl {
  ...
  "baseline-browser-mapping@2.8.28" = fetchurl {
  ...
  "cjs-module-lexer@2.1.1" = fetchurl {
  ...
  "core-js-compat@3.46.0" = fetchurl {
  ...
  "electron-to-chromium@1.5.254" = fetchurl {
  ...
  "eslint-config-oclif@5.2.2" = fetchurl {
  ...
  "eslint-config-oclif@6.0.118" = fetchurl {
  ...
  "eslint-config-xo-space@0.35.0" = fetchurl {
  ...
  "eslint-config-xo@0.44.0" = fetchurl {
  ...
  "eslint-config-xo@0.49.0" = fetchurl {
  ...
  "eslint-plugin-jsdoc@50.8.0" = fetchurl {
  ...
  "eslint-plugin-mocha@10.5.0" = fetchurl {
  ...
  "eslint-plugin-only-warn@1.1.0" = fetchurl {
  ...
  "eslint-plugin-perfectionist@4.15.1" = fetchurl {
  ...
  "eslint-plugin-turbo@2.6.1" = fetchurl {
  ...
  "eslint-plugin-unicorn@48.0.1" = fetchurl {
  ...
  "init-package-json@7.0.2" = fetchurl {
  ...
  "is-retry-allowed@1.2.0" = fetchurl {
  ...
  "jest-changed-files@30.2.0" = fetchurl {
  ...
  "jest-environment-node@30.2.0" = fetchurl {
  ...
  "jest-haste-map@30.2.0" = fetchurl {
  ...
  "jest-leak-detector@30.2.0" = fetchurl {
  ...
  "jest-matcher-utils@30.2.0" = fetchurl {
  ...
  "jest-message-util@30.2.0" = fetchurl {
  ...
  "jest-resolve-dependencies@30.2.0" = fetchurl {
  ...
  "jsdoc-type-pratt-parser@4.1.0" = fetchurl {
  ...
  "natural-orderby@3.0.2" = fetchurl {
  ...
  "parse-conflict-json@4.0.0" = fetchurl {
  ...
  "react-dnd-html5-backend@14.1.0" = fetchurl {
  ...
  "react-hook-form@7.66.0" = fetchurl {
  ...
  "sort-package-json@2.15.1" = fetchurl {
  ...
  "tiny-relative-date@1.3.0" = fetchurl {
  ...
  "typescript-eslint@8.46.4" = fetchurl {
