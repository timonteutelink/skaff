...
* Pull the latest image:
  ...
  ```bash
  docker pull timonteutelink/skaff-web:latest
  ```
* Run the container:

  ```bash
  docker run -p 3000:3000 -v ~/.config/skaff:/home/node/.config/skaff timonteutelink/skaff-web:latest
  ```
...
**2. Running locally with Node:** If you have Node.js and pnpm installed and have cloned the `skaff` repository, you can run the web app directly:
